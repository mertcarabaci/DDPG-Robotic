...
class DDPG(nn.Module):
    def __init__(self, state, action_space):
        ...
        self.actor = ActorNet(self.observation_dim, self.action_dim).to(DEVICE)
        self.actor_target = ActorNet(self.observation_dim, self.action_dim).to(DEVICE)
        self.actor_target.load_state_dict(self.actor.state_dict())

        self.critic = CriticNet(self.observation_dim, self.action_dim).to(DEVICE)
        self.critic_target = CriticNet(self.observation_dim, self.action_dim).to(DEVICE)
